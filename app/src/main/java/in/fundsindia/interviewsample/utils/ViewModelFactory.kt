...
@Inject constructor(private val creators: Map<Class<out ViewModel>, @JvmSuppressWildcards Provider<ViewModel>>) : ViewModelProvider.Factory {
    ...
    /**
     * @param  modelClass a param a viewmodel class type to which has to be get back as model class object
     * @return  get the ViewModel provider based on given class
     */
